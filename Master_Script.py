...
Inputs:
C:/Users/User/Documnets/University/Year 4/Project/Julia_Working_Directory/Randoms_ID_Values.txt
C:/Users/User/Documnets/University/Year 4/Project/Julia_Working_Directory/Graham_ID_Values.txt
C:/Users/User/Documnets/University/Year 4/Project/Julia_Working_Directory/Randoms_Data/...
C:/Users/User/Documnets/University/Year 4/Project/Julia_Working_Directory/Grahams_Data/...

This will then create a Data file:
C:/Users/User/Documnets/University/Year 4/Project/Julia_Working_Directory/Randoms_Data/state-3-2.dat.txt
C:/Users/User/Documnets/University/Year 4/Project/Julia_Working_Directory/Grahams_Data/state-3-2.dat.txt
...
def main():
    ...
    if Analyse_Random == 'Y':
        for i in range(No_Random_Obj):
            ...
            if User == 'N':
                subprocess.Popen(r'julia C:/Users/User/.julia/v0.5/CARMA/bin/run_carma.jl ' + Data_text + ' 3 2' , cwd=r'C:/Users/User/Documents/University/Year 4/Project/Julia_Working_Directory/Randoms_Data')
                #subprocess.Popen(r'julia julia_script_path', cwd=...)
            elif User =='C':
                subprocess.Popen(r'julia C:/Users/User/.julia/v0.5/CARMA/bin/run_carma.jl ' + Data_text + ' 3 2' , cwd=r'C:/Users/User/Documents/University/Year 4/Project/Julia_Working_Directory/Randoms_Data')
                #subprocess.Popen(r'julia julia_script_path', cwd=...)
    ...
    if Analyse_Graham == 'Y':
        for i in range(No_Graham_Obj):
            ...
            #Open command window and perform nested sampling. Re-open command and run julia analysis script
            if User == 'N':
                subprocess.Popen(r'julia C:/Users/User/.julia/v0.5/CARMA/bin/run_carma.jl ' + Data_text + ' 3 2' , cwd=r'C:/Users/User/Documents/University/Year 4/Project/Julia_Working_Directory/Grahams_Data')
                #subprocess.Popen(r'julia julia_script_path', cwd=...)
            elif User == 'C':
                subprocess.Popen(r'julia C:/Users/User/.julia/v0.5/CARMA/bin/run_carma.jl ' + Data_text + ' 3 2' , cwd=r'C:/Users/User/Documents/University/Year 4/Project/Julia_Working_Directory/Grahams_Data')
                #subprocess.Popen(r'julia julia_script_path', cwd=...)
            ...
            #Print an output for each object completion
            print('Iteration', i, 'complete for Random Object')
